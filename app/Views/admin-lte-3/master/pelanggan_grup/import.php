    ...
    <div class="col-12">
        <div class="card rounded-0">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-file-import mr-2"></i>Import Data Grup Pelanggan
                </h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                ...
                <?= form_open_multipart('master/customer-group/import', ['class' => 'form-horizontal']) ?>
            ...
            <div class="card-footer">
                <a href="<?= base_url('master/customer-group') ?>" class="btn btn-default rounded-0">
                    <i class="fas fa-arrow-left mr-2"></i>Kembali
                </a>
                <a href="<?= base_url('master/customer-group/template') ?>" class="btn btn-info rounded-0">
